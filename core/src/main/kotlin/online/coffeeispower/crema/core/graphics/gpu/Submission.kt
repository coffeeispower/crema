...
import online.coffeeispower.crema.core.synchronization.Latch

/**
 * A render submission: the work a [online.coffeeispower.crema.core.graphics.renderer.Renderer] recorded for the GPU that owns it,
