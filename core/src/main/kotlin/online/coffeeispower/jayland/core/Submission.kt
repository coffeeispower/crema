...
/**
 * A render submission: the work a [Renderer] recorded for the GPU that owns it,
 ...
 * returned file descriptor to the caller. The software-side [signal] remains
...
interface Submission : AutoCloseable {
    ...
    /** Opaque software-side completion signal. */
    val signal: Signal
